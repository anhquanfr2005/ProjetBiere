<?php	
	...
	for($i=0;$i<=$lignes;$i++){
		$rgb=hexargb(substr(str_shuffle("ABCDE0123456789"),0,6));//choisi une couleur aléatoirement (str_shuffle), de 6 caractères (substr(chaine,0,6)) avec la sélection alphanumérique
